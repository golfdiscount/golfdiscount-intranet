...
CREATE TABLE wsi_orders.customer(
...
CREATE TABLE wsi_orders.recipient(
...
CREATE TABLE wsi_orders.pick_ticket(
	pick_ticket_num VARCHAR(30) PRIMARY KEY,
	order_num VARCHAR(30) UNIQUE
);

CREATE TABLE wsi_orders.wsi_order(
...
CREATE TABLE wsi_orders.product(
	sku VARCHAR(32) PRIMARY KEY,
	sku_name TEXT NOT NULL,
	unit_price FLOAT NOT NULL
);

CREATE TABLE wsi_orders.line_item(
...
CREATE TABLE wsi_orders.shipping_conf(
	pick_ticket_num VARCHAR(30),
	line_num INT,
